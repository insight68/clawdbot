...
export const useChatStore = create<ChatState>()(
  persist(
    (set, get) => ({
      ...
      setStream: (stream, startedAt) => set({ stream: stream, streamStartedAt: startedAt ?? Date.now() }),
      ...
      setSidebarContent: (content, error) => set({ sidebarContent: content, sidebarError: error ?? null }),
