  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <main style={{ maxWidth: '800px' }}>
        ...
        <section style={{ padding: '1.5rem', backgroundColor: 'var(--bg-tertiary)', borderRadius: '0.5rem' }}>
          <h2>Gateway 连接测试</h2>
      ...
      <footer style={{ marginTop: '3rem', paddingTop: '1rem', borderTop: '1px solid var(--border)', textAlign: 'center', color: 'var(--text-secondary)' }}>
        <p>迁移状态: 阶段 0 完成 ✅</p>
      </footer>
    </div>
  );
