...
describe("config form renderer", () => {
  it("renders inputs and patches values", () => {
    ...
    const tokenButton = Array.from(container.querySelectorAll(".cfg-segmented__btn")).find(
  ...
  it("renders union literals as select options", () => {
    ...
    const tailnetButton = Array.from(container.querySelectorAll(".cfg-segmented__btn")).find(
