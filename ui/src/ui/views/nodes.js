...
function resolveExecApprovalsState(props) {
    ...
    const selectedAgent = selectedScope !== EXEC_APPROVALS_DEFAULT_SCOPE
        ? ((form?.agents ?? {})[selectedScope] ?? null)
        : null;
    const allowlist = Array.isArray(selectedAgent?.allowlist)
        ...
        : html `
            ...
            state.onBindDefault(value ? value : null);
                    ...
                    >
                      ...
                      ${state.nodes.map((node) => html `<option
                            value=${node.id}
        ...
        ? html `
            ...
            state.onSelectTarget("node", value ? value : null);
                  ...
                  >
                    ...
                    ${state.targetNodes.map((node) => html `<option
                          value=${node.id}
...
function renderExecApprovalsPolicy(state) {
    ...
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        ...
        : nothing}
              ${SECURITY_OPTIONS.map((option) => html `<option
                    value=${option.value}
      ...
      <div class="list-item">
        ...
        : nothing}
              ${ASK_OPTIONS.map((option) => html `<option
                    value=${option.value}
