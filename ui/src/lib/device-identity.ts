// Device Identity for Next.js
// Ed25519 key pair management for device authentication
...
export async function loadOrCreateDeviceIdentity(): Promise<DeviceIdentity> {
  if (typeof window === "undefined") {
    throw new Error("loadOrCreateDeviceIdentity can only be called in the browser");
  }
